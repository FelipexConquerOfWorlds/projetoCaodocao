    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="../controller/sfdklogado.php?acao=doar" class="btn btn-lg btn-warning mx-1 text-dark">Doar</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-12">
              <h1 class="text-warning">Sobre</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container bg-dark">
      <div class="row mb-5">
        <div class="col-md-6 bg-dark       offset-md-1" style="transition: all 0.25s;">
          <h2 class="text-warning">Article subtitle #1</h2>
  ...
  <div class="bg-warning py-0">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12 bg-dark p-2 py-5">
          <h1 class="mb-4 text-warning">Benefits and features</h1>
          <p class="lead">Design unique interfaces by customizing Bootstrap theme with Pingendo. <br>Modify colors, fonts and grid setting without opening any CSS file.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 my-3">
          <h1 class="display-4 text-white text-md-left text-center">IFC-Araquari-3info1 &nbsp;</h1>
        </div>
