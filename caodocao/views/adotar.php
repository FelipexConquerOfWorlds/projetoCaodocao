...
<nav class="navbar navbar-expand-md navbar-light bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand" href="#">
            <b style="background-image: url('../../projetoCaodocao-master/caodocao/assets/img/logo.png');background-position:left center;background-repeat:repeat;"
               class="w-75"> </b>
        </a>
...
<div class="py-5 text-center bg-warning">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="mb-4 text-dark">Animais</h1>
                <div class="btn-group">
                    <button class="btn btn-dark dropdown-toggle" data-toggle="dropdown"> Espécie</button>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Cachorro</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">Gato</a>
                    </div>
                </div>
                <div class="btn-group">
                    <button class="btn btn-dark dropdown-toggle" data-toggle="dropdown"> Raça</button>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Poddle</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">Bulldog</a>
                    </div>
                </div>
                <div class="btn-group">
                    <button class="btn btn-dark dropdown-toggle" data-toggle="dropdown"> Localização</button>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Joinville</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">São fransciso do Sul</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3 col-6 p-1">
                <a href="#">
                    <img class="d-block img-fluid" src="../views/img/portfolio/5a619b043c40c6c846e25bf41db7eebe.jpg">
                </a>
            </div>
            <div class="col-md-3 col-6 p-1">
                <a href="#">
                    <img class="d-block img-fluid"
                         src="../views/img/portfolio/REINOUNIDO_serialkiller_gatos_pexels-126407.jpg"> </a>
            </div>
            <div class="col-md-3 col-6 p-1">
                <a href="#">
            ...
            <div class="col-md-3 col-6 p-1">
                <a href="#">
                    <img class="d-block img-fluid" src="../views/img/portfolio/síntomas-de-moquillo-en-gatos_opt.jpg">
                </a>
            </div>
        </div>
    </div>
